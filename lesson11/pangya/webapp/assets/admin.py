...
class AssetsAdmin(admin.ModelAdmin):
    ...
    #fk_fields 设置显示外键字段
    fk_fields = ('mem_total',)
    search_fields = ('id','hostname','cpu_num','cpu_model','mem_total','disk','public_ip','private_ip','remote_ip','op','status','os_system','service_line','frame','remark','create_time','update_time')
    #筛选器
