...
class Assets(models.Model):
    ...
    cpu_num             =   models.IntegerField(null=True, blank=True, verbose_name="cpu核")
    ...
    status              =   models.IntegerField(choices=STATUS_CHOICE, null=True, blank=True, verbose_name="机器的状态0 | 1")
