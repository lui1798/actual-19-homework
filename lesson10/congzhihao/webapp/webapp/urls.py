...
from assets.views import assetviews,deleteasset,addPageAssetsView,addAssetsView
...
urlpatterns = [
    ...
    url(r'^ssum/', ssum),
    url(r'^cmd/', cmd1),
    url(r'^asset/$', assetviews),
    url(r'^asset/delete/$', deleteasset),
    url(r'^asset/addpage/$', addPageAssetsView),
    url(r'^asset/add/', addAssetsView),
]
