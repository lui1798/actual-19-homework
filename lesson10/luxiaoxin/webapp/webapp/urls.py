...
from assets.views import assetsview, deleteasset, add_assetsview, add_host, edit_assetsview, edit_host
...
urlpatterns = [
    ...
    url(r'^assets/delete/$', deleteasset),
    url(r'^assets/addview/$', add_assetsview),
    url(r'^assets/add/$', add_host),
    url(r'^assets/editview/$', edit_assetsview),
    url(r'^assets/edit/$', edit_host),
]
